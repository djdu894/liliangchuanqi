...
Section:Button("自动举哑铃", Toggleflag",false,function(state)
...
Section:Button("自动俯卧撑", Toggleflag",false,function(state)
...
Section:Button("自动仰卧起坐", Toggleflag",false,function(state)
...
Section:Button("自动倒立身体", Toggleflag",false,function(state)
...
Section:Button("自动重生", Toggleflag",false,function(state)
  while ATRE do wait() game:GetService("ReplicatedStorage").rEvents.rebirthRemote:InvokeServer("rebirthRequest") end
end)

Section1:Button("沙滩跑步机10", Toggleflag",false,function(state)
...
Section1:Button("健身房跑步机2000", Toggleflag",false,function(state)
...
Section1:Button("神话健身房跑步机2000", Toggleflag",false,function(state)
...
Section1:Button("永恒健身房跑步机3500", Toggleflag",false,function(state)
...
Section1:Button("传奇健身房跑步机3000", Toggleflag",false,function(state)
